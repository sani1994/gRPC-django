...
class UserControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Product = channel.unary_unary(
                '/account.UserController/Product',
                request_serializer=account__pb2.product_list_req.SerializeToString,
                response_deserializer=account__pb2.Product_message.FromString,
                )
...
def add_UserControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Product': grpc.unary_unary_rpc_method_handler(
                    servicer.Product,
                    request_deserializer=account__pb2.product_list_req.FromString,
                    response_serializer=account__pb2.Product_message.SerializeToString,
            ),
    }
...
class UserController(object):
    ...
    def Product(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/account.UserController/Product',
            account__pb2.product_list_req.SerializeToString,
            account__pb2.Product_message.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class ProductControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.List = channel.unary_stream(
                '/account.ProductController/List',
                request_serializer=account__pb2.product_list_req.SerializeToString,
                response_deserializer=account__pb2.Product_message.FromString,
                )
...
def add_ProductControllerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'account.ProductController', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class ProductController(object):
    ...
    def List(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/account.ProductController/List',
            account__pb2.product_list_req.SerializeToString,
            account__pb2.Product_message.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
